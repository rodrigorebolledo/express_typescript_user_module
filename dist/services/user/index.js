...
function getIsTheFirstUser() {
    return __awaiter(this, void 0, void 0, function* () {
        const count = yield (0, repositories_2.getUserCount)();
        if (count === 0)
            return true;
        return false;
    });
...
function getUserFromIdService(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, repositories_2.getUserFromId)(id);
    });
}
exports.getUserFromIdService = getUserFromIdService;
function isAdminService(username) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingUser = yield (0, repositories_2.getUserFromUserName)(username);
        if (existingUser) {
            const { role_id } = existingUser;
            const role = yield (0, repositories_1.getRoleFromId)(role_id);
            if (role) {
                const { name } = role;
...
function updateUserService(id, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const user = yield (0, repositories_2.updateUserRepository)(id, username, encryptedPasswordBuffer);
            if (!user) {
...
function deleteUserFromIdService(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, repositories_2.deleteUserFromId)(id);
    });
}
exports.deleteUserFromIdService = deleteUserFromIdService;
function getUserFromUserNameService(username) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, repositories_2.getUserFromUserName)(username);
    });
}
